"""
Django settings for parkandride project.
...
SECRET_KEY = "django-insecure-x91$be+56-mjo))v#hr(=+t^+v2+2_^hz$y!x=7l3nco1ccyvn"
...
WSGI_APPLICATION = "parkandride.wsgi.application"
